...
-->
# FILE_MAP — GhostLock-X200 v1.3.3 逐文件映射（中文版）
...
| `release_notes_v1.3.3.md` | 本版 release 更新日志（历史更新日志归档于 docs/release_notes/） | LOCAL | Apache-2.0 |
| `docs/ARCHITECTURE.md` | 架构 / STAGE 流程 / 组件映射 | LOCAL | Apache-2.0 |
| `docs/release_notes/` | 历史 release 更新日志归档（v1.1.0 / v1.3.0 / v1.3.1） | LOCAL | Apache-2.0 |
