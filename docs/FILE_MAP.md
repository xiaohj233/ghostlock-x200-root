# FILE_MAP — GhostLock-X200 v1.3.3 file-by-file map
...
| `release_notes_v1.3.3.md` | release changelog for v1.3.3 (current; older changelogs archived under docs/release_notes/) | LOCAL | Apache-2.0 |
